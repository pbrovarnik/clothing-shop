const __vite__fileDeps=["assets/homepage.component-C5GjBm6-.js","assets/homepage-C9qRPidx.css","assets/sign-in-and-sign-out.component-DRUTyK4f.js","assets/sign-in-and-sign-out-BLBt2cjx.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wz(){return new kc("deleteField")}function Hz(){return new Dw("serverTimestamp")}function Kz(...t){return new Ow("arrayUnion",t)}function Qz(...t){return new Vw("arrayRemove",t)}function Yz(t){return new Lw("increment",t)}(function(e,n=!0){(function(i){Qa=i})(os),Hi(new Cr("firestore",(r,{instanceIdentifier:i,options:s})=>{const o=r.getProvider("app").getImmediate(),a=new st(new rB(r.getProvider("auth-internal")),new aB(r.getProvider("app-check-internal")),function(c,h){if(!Object.prototype.hasOwnProperty.apply(c.options,["projectId"]))throw new z(U.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Yi(c.options.projectId,h)}(o,i),o);return s=Object.assign({useFetchStreams:n},s),a._setSettings(s),a},"PUBLIC").setMultipleInstances(!0)),or(wT,"4.6.3",e),or(wT,"4.6.3","esm2017")})();const Jz="@firebase/firestore-compat",Xz="0.3.32";/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,FG=Yn.div`
	${jx}
`,UG=({currentUser:t,hidden:e,signOutStart:n})=>ue.jsxs(VG,{children:[ue.jsx(LG,{to:"/",children:ue.jsx("img",{className:"logo",src:yq,alt:"Logo"})}),ue.jsxs(MG,{children:[ue.jsx(GS,{to:"/shop",children:"SHOP"}),t?ue.jsx(FG,{onClick:n,children:"SIGN OUT"}):ue.jsx(GS,{to:"/signIn",children:"SIGN IN"}),ue.jsx(Iq,{})]}),e?null:ue.jsx(OG,{})]}),$G=dx({currentUser:Kw,hidden:D5}),BG=t=>({signOutStart:()=>t(K5())}),jG=Bf($G,BG)(UG),zG=Yn.div`
	height: 60vh;
	width: 100%;
	display: flex;
	justify-content: center;
...
`,XG=ln.lazy(()=>kp(()=>import("./homepage.component-C5GjBm6-.js"),__vite__mapDeps([0,1]))),ZG=ln.lazy(()=>kp(()=>import("./shop.component-BfXXu2_Z.js"),[])),e8=ln.lazy(()=>kp(()=>import("./sign-in-and-sign-out.component-DRUTyK4f.js"),__vite__mapDeps([2,3]))),t8=ln.lazy(()=>kp(()=>import("./checkout.compenent-Dbhx1BUA.js"),[])),n8=({checkUserSession:t,currentUser:e})=>(ln.useEffect(()=>{t()},[t]),ue.jsxs("div",{children:[ue.jsx(JG,{}),ue.jsx(jG,{}),ue.jsx(YG,{children:ue.jsx(ln.Suspense,{fallback:ue.jsx(GG,{}),children:ue.jsxs(GV,{children:[ue.jsx(gh,{exact:!0,path:"/",component:XG}),ue.jsx(gh,{path:"/shop",component:ZG}),ue.jsx(gh,{exact:!0,path:"/checkout",component:t8}),ue.jsx(gh,{exact:!0,path:"/signin",render:()=>e?ue.jsx(yI,{to:"/"}):ue.jsx(e8,{})}),ue.jsx(yI,{to:"/"})]})})})]})),r8=t=>({currentUser:Kw(t)}),i8=t=>({checkUserSession:()=>t(H5())}),s8=Bf(r8,i8)(n8);eg.createRoot(document.getElementById("root")).render(ue.jsx(ae.StrictMode,{children:ue.jsx(YL,{store:gx,children:ue.jsx(HV,{basename:"/clothing-shop",children:ue.jsx(CP,{persistor:pq,children:ue.jsx(s8,{})})})})}));export{bG as C,gh as R,GG as S,kp as _,dx as a,Bf as b,ru as c,GV as d,yI as e,w8 as f,A8 as g,P8 as h,S8 as i,ue as j,I8 as k,T8 as l,qO as m,Rp as n,E8 as o,Yn as p,a2 as q,ln as r,R8 as s,Iu as t,ff as u,WV as w};
